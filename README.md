...
课堂点名计时器是一款专为教师打造的 Windows 桌面工具，集 **随机点名**、**课堂计时**、**屏幕批注**、**白板**、**自动化调度** 等功能于一体。
...
前往 [Releases](../../releases) 页面下载最新版 `课堂点名计时器安装包.exe`，双击运行安装向导即可。
